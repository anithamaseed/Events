...
class Events extends Component {
  state = {activeEvent: '', activeId: ''}

  onClickEvent = (id, registrationStatus) => {
    this.setState({activeEvent: registrationStatus, activeId: id})
  }

  render() {
    const {activeEvent, activeId} = this.state
    return (
      <div className="app-container">
        <div className="app-bg-container">
          <h1 className="app-heading">Events</h1>
